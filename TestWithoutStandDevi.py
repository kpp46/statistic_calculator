...
def TestWithoutStandDevi(proportion, probability, precision):
    p = probability
...
def result_withoutStandDevi(proportion, probability, precision):
    p = probability
    print(p)
    p1 = float(proportion / 100)
    print(p1)
...
print(TestWithoutStandDevi(41, 95, 0.06))
